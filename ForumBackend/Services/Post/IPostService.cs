...
public interface IPostService
{
    ...
    Task<IReadOnlyCollection<PostResponseContract>> GetInterestingPostsAsync(Guid userUid,
        CancellationToken cancellationToken);

    Task<IReadOnlyCollection<PostResponseContract>> GetAllByUserUidAsync(Guid userUid,
        CancellationToken cancellationToken);

    Task<PostResponseWithImagesContract?> GetByUidAsync(Guid uid, CancellationToken cancellationToken);

    Task<PostResponseWithImagesContract> CreateAsync(CreatePostRequestContract request,
        CancellationToken cancellationToken);

    Task<PostResponseWithImagesContract?> UpdateAsync(Guid uid, UpdatePostRequestContract request,
        CancellationToken cancellationToken);
